...
<head>
  ...
  <style>
    body { font-family: Arial; margin: 40px; background:#81eae6; }
    table { width: 80%; margin: auto; border-collapse: collapse; }
    th, td { border: 3px solid #ddd; padding: 10px; text-align: center; }
    th { background: #2c3e50; color: white; }
  </style>
</head>
<body>
  <h2 style="text-align:center; font-size:25px;">Recommended Colleges</h2>
  <table>
    <tr>
      <th>Name</th>
      <th>Location</th>
